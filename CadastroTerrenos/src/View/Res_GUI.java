 ...
 */
public class Res_GUI extends javax.swing.JFrame {

    /**
     * Creates new form Res_GUI
     */
    public Res_GUI() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Res_GUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
